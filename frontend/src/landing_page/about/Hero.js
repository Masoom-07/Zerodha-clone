    ...
    <div className="container" style={{ marginTop: "110px" }}>
      ...
      <div className="row p-5 mt-2 text-muted ">
        ...
        <div className=" col-7 p-5" style={{ fontSize: "1.2em" }}>
          ...
          <p>
            Connect on{" "}
            <a href="https://zerodha.com/about" style={{ textDecoration: "none" }}>
              Homepage
            </a>
            /
            <a href="https://tradingqna.com/u/nithin" style={{ textDecoration: "none" }}>
              TradingQna
            </a>
            /
            <a href="https://x.com/Nithin0dha" style={{ textDecoration: "none" }}>
              Twitter
            </a>
          </p>
        </div>
